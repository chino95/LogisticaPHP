...
<ul class="my-tweets">
	...
	<?php foreach($tweets as $tweet) { ?>
			...
			<li class="tweet-item slide">
				...
				<a class="date" href="http://twitter.com/<?php echo $tweet['user']['screen_name']; ?>/statuses/<?php echo $tweet['id_str']; ?>" class="themex_twt_date"><?php echo date("d/m/Y", $tweet_time); ?></a>
